    ...
    <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden flex flex-col justify-between p-6">
      ...
      <div className="relative flex-1 min-h-0 mt-0 w-full">
        ...
        {selectedCountry && conqueredCountries[selectedCountry.ADMIN] ? (
          <div className="flex fixed bottom-[72px] md:bottom-6 right-0 md:right-6 bg-black/95 md:bg-black/40 backdrop-blur-xl md:glass-panel w-full md:w-96 max-h-[70vh] md:max-h-[calc(100vh-120px)] flex-col rounded-t-2xl md:rounded-2xl pointer-events-auto border-red-500 border-2 shadow-[0_0_30px_rgba(239,68,68,0.2)] transition-all duration-300 animate-in slide-in-from-bottom-10 md:slide-in-from-right-10 overflow-hidden z-30">
          ...
          <div className="flex fixed bottom-[72px] md:bottom-6 right-0 md:right-6 bg-black/95 md:bg-black/40 backdrop-blur-xl md:glass-panel w-full md:w-96 max-h-[75vh] md:max-h-[calc(100vh-120px)] flex-col rounded-t-2xl md:rounded-2xl pointer-events-auto border-neonCyan border transition-all duration-300 animate-in slide-in-from-bottom-10 md:slide-in-from-right-10 overflow-hidden z-30">
